...
Motor leftMotor3 (3, E_MOTOR_GEAR_GREEN, false, E_MOTOR_ENCODER_DEGREES); // We have a motor stack. This is a stacked motor and it needs to be reversed
...
Motor rightMotor3 (3, E_MOTOR_GEAR_GREEN, false, E_MOTOR_ENCODER_DEGREES); // We have a motor stack. This is a stacked motor and it needs to be reversed
